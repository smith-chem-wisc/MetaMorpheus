...
namespace OldInternalLogic
{
	public class PeptideWithPossibleModifications : Peptide
	{
		...
		static IEnumerable<int[]> GetVariableModificationPatterns(List<KeyValuePair<int, UniqueModificationsList>> possibleVariableModifications, int unmodifiedResiduesDesired, int[] variableModificationPattern, int index)
		{
		...
		static Dictionary<int, MorpheusModification> GetNewVariableModificationPattern(int[] variableModificationArray, IEnumerable<KeyValuePair<int, UniqueModificationsList>> possibleVariableModifications)
		{
