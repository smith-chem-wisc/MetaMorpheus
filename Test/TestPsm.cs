...
namespace Test
{
    ...
    public static class TestPsm
    {
        ...
        public static void TestLongestFragmentIonSequence()
        {
            ...
            new ClassicSearchEngine(allPsmsArray, listOfSortedms2Scans, variableModifications, fixedModifications, null, null, proteinList, searchModes, new CommonParameters(), new List<string>()).Run();
