...
namespace Test
{
    ...
    public static class FdrTest
    {
        ...
        public static void TestComputePEPValue()
        {
            ...
            var accessionCounts = PEPValueAnalysisGeneric.GetAccessionCounts(nonNullPsms);
            ...
            var maxPsmData = PEPValueAnalysisGeneric.CreateOnePsmDataFromPsm(maxScorePsm, accessionCounts, sequenceToPsmCount);
            ...
            PEPValueAnalysisGeneric.ComputePEPValuesForAllPSMsGeneric(nonNullPsms);
