...
namespace Test
{
    ...
    public class CalibrationEngineTests
    {
        ...
        public static void TestCalibrationEngine()
        {
            ...
            List<SingleScanManyPeptidesMatch> identifications = new List<SingleScanManyPeptidesMatch>();
            ...
            SingleScanManyPeptidesMatch newPsm = new SingleScanManyPeptidesMatch(pepWithSetMods.CompactPeptide, 0, 0, 0, scan);
        ...
        public static void TestQuadratic()
        {
            ...
            var res = new CalibrationEngine(myMsDataFile, fragmentTolerance, new List<SingleScanManyPeptidesMatch> { newPsm }, 3, 2, 10, new PpmTolerance(10), FragmentTypes.b | FragmentTypes.y, (List<LabeledMs1DataPoint> theList, string s) => {; }, (List<LabeledMs2DataPoint> theList, string s) => {; }, true, new List<string>()).Run();
            Assert.IsTrue(res is CalibrationResults);
        }
