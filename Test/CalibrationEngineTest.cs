...
namespace Test
{
    ...
    public class CalibrationEngineTests
    {
        ...
        public static void TestCalibrationEngine()
        {
            ...
            PeptideWithPossibleModifications modPep = ParentProtein.Digest(protease, 0, null, null, InitiatorMethionineBehavior.Variable, fixedModifications, TerminusType.None).First();
