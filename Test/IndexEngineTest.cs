...
namespace Test
{
    ...
    public class IndexEngineTest
    {
        ...
        public static void TestIndexEngine()
        {
            ...
            var engine = new IndexingEngine(proteinList, variableModifications, fixedModifications, protease, InitiatorMethionineBehavior.Variable, 2, null, null, 4096, new List<ProductType> { ProductType.BnoB1ions, ProductType.Y }, new List<string>());
        ...
        public static void TestIndexEngineWithWeirdSeq()
        {
            ...
            var engine = new IndexingEngine(proteinList, variableModifications, fixedModifications, protease, InitiatorMethionineBehavior.Retain, 2, null, null, 4096, new List<ProductType> { ProductType.BnoB1ions, ProductType.Y }, new List<string>());
            var results = (IndexingResults)engine.Run();
