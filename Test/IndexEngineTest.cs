...
namespace Test
{
    ...
    public static class IndexEngineTest
    {
        ...
        public static void TestIndexEngine()
        {
            ...
            var engine = new IndexingEngine(proteinList, variableModifications, fixedModifications, null, null, 1, DecoyType.None, CommonParameters, 30000, false, new List<FileInfo>(), new List<string>());
        ...
        public static void TestIndexEngineWithWeirdSeq()
        {
            ...
            var engine = new IndexingEngine(proteinList, variableModifications, fixedModifications, null, null, 1, DecoyType.Reverse, CommonParameters, 30000, false, new List<FileInfo>(), new List<string>());
