...
namespace Test
{
    ...
    public static class MultiProteaseParsimonyTest
    {
        ...
        public static void MultiProteaseTest()
        {
            ...
            psms.ForEach(j => j.SetFdrValues(1, 0, 0, 1, 0, 0, 0));
        ...
        public static void MultiProteaseSamePeptideSameProteinsDifferentProteases()
        {
            ...
            psms.ForEach(p => p.SetFdrValues(1, 0, 0, 1, 0, 0, 0));
        ...
        public static void MultiProteaseParsimony_IndistringuishableProteinsNowDistinguishable()
        {
            ...
            psms.ForEach(h => h.SetFdrValues(1, 0, 0, 1, 0, 0, 0));
        ...
        public static void MultiProteaseParsimony_SameAminoAcidsResultInTwoUniquePeptidesForOneProtein()
        {
            ...
            foreach (var pwsm in peptideList)
            {
                ...
                psms.Last().SetFdrValues(0, 0, 0, 0, 0, 0, 0);
        ...
        public static void TestPSMFdrFiltering_Simulated()
        {
            ...
            for (int i = 0; i < peptideList.Count(); i++)
            {
                ...
                {
                    case 0:
                        psms.Last().SetFdrValues(0, 0, goodFdr, 0, 0, badFdr, 0);
                        break;

                    case 1:
                        psms.Last().SetFdrValues(0, 0, badFdr, 0, 0, goodFdr, 0);
                        break;

                    case 2:
                        psms.Last().SetFdrValues(0, 0, goodFdr, 0, 0, goodFdr, 0);
                        break;

                    case 3:
                        psms.Last().SetFdrValues(0, 0, badFdr, 0, 0, badFdr, 0);
                        break;
            ...
            psms.ElementAt(5).SetFdrValues(0, 0, goodFdr, 0, 0, goodFdr, 0);
