...
namespace Test
{
    ...
    internal static class AddCompIonsTest
    {
        ...
        public static void TestAddCompIonsClassic()
        {
            ...
            new ClassicSearchEngine(allPsmsArray2, listOfSortedms2Scans, variableModifications, fixedModifications, proteinList, new List<ProductType> { ProductType.B, ProductType.Y }, searchModes, true, CommonParameters, CommonParameters.ProductMassTolerance, new List<string>()).Run();
        ...
        public static void TestCompIons_ModernSearch()
        {
            ...
            new ModernSearchEngine(allPsmsArray2, listOfSortedms2Scans, indexResults.PeptideIndex, indexResults.FragmentIndex, new List<ProductType> { ProductType.B, ProductType.Y }, 0, CommonParameters, SearchParameters.AddCompIons, massDiffAcceptor, null, new List<string>()).Run();
