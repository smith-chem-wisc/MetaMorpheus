...
namespace Test
{
    ...
    internal static class AddCompIonsTest
    {
        ...
        public static void TestAddCompIonsClassic()
        {
            ...
            new ClassicSearchEngine(allPsmsArray2, listOfSortedms2Scans, variableModifications, fixedModifications, null, null, proteinList, searchModes, CommonParameters2, new List<string>()).Run();
        ...
        public static void AddCompIonsCommonParams()
        {
            ...
            var indexEngine = new IndexingEngine(proteinList, variableModifications, fixedModifications, new List<SilacLabel>(), null,
