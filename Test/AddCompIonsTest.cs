...
namespace Test
{
    ...
    internal class AddCompIonsTest
    {
        ...
        public static void TestCompIons_ModernSearch()
        {
            ...
            var indexEngine = new IndexingEngine(proteinList, variableModifications, fixedModifications, protease, initiatorMethionineBehavior, 2, null, null, 4096, new List<ProductType> { ProductType.B, ProductType.Y }, new List<string>(), TerminusType.C);
