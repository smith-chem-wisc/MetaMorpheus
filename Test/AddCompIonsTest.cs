...
namespace Test
{
    ...
    internal static class AddCompIonsTest
    {
        ...
        public static void TestCompIons_MatchIonsScore()
        {
            ...
            double scoreT = MetaMorpheusEngine.CalculateMatchQualityFeatures(t.GetOneBasedScan(2), productMassTolerance, sorted_theoretical_product_masses_for_this_peptide, precursorMass, new List<DissociationType> { DissociationType.HCD }, true);
            double scoreF = MetaMorpheusEngine.CalculateMatchQualityFeatures(t.GetOneBasedScan(2), productMassTolerance, sorted_theoretical_product_masses_for_this_peptide, precursorMass, new List<DissociationType> { DissociationType.HCD }, false);
