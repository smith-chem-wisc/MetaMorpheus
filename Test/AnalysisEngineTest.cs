...
namespace Test
{
    ...
    public static class AnalysisEngineTests
    {
        ...
        public static void TestAnalysisEngineTests()
        {
            ...
            CommonParameters CommonParameters = new CommonParameters(DigestionParams: new DigestionParams(protease: protease.Name, MaxMissedCleavages: 0, MinPeptideLength: 1, MaxModificationIsoforms: 1042), ScoreCutoff: 1, prodMassTol: 10);
