    ...
    public class RobTest
    {
        ...
        public static void TestParsimony()
        {
            ...
            for (int i = 0; i < sequences.Length; i++)
                p.Add(new Protein(sequences[i], (i + 1).ToString(), new Dictionary<int, HashSet<BaseModification>>(), new int?[0], new int?[0], null, "", "", 0, false, false));
            p.Add(new Protein("-----F----*", "D", new Dictionary<int, HashSet<BaseModification>>(), new int?[0], new int?[0], null, "", "", 0, true, false));
