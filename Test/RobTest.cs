...
namespace Test
{
    ...
    public class RobTest
    {
        ...
        public static void TestParsimony()
        {
            ...
            AnalysisEngine ae = new AnalysisEngine(new PsmParent[0][], dictionary, new List<Protein>(), null, null, null, null, null, null, null, null, null, true, true, true, 0, null, null, 0, false, new List<ProductType> { ProductType.B, ProductType.Y }, double.NaN, InitiatorMethionineBehavior.Variable, new List<string>(), false, false, 0, modsDictionary, null, new List<string> { "file" });
        ...
        public static void TestQuantification()
        {
            ...
            AnalysisEngine ae = new AnalysisEngine(new PsmParent[0][], null, new List<Protein>(), null, null, null, null, null, null, null, null, null, false, false, false, 0, null, null, 0, false, new List<ProductType> { ProductType.B, ProductType.Y }, double.NaN, InitiatorMethionineBehavior.Variable, new List<string>(), false, false, 0, modsDictionary, myMsDataFile, new List<string> { "TestDataFile" });
