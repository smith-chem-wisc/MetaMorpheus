...
namespace Test
{
    ...
    public static class MsDataFileTest
    {
        ...
        public static void TestLoadAndRunMgf()
        {
            ...
            var engine = new EverythingRunnerEngine(taskList, new List<string> { mgfName }, new List<DbForTask> { new DbForTask(xmlName, false) }, TestContext.CurrentContext.TestDirectory);
            engine.Run();
