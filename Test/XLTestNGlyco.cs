...
namespace Test
{
    ...
    public class XLTestNGlyco
    {
        ...
        public static void GlyTest_RunTask()
        {
            ...
            string outputDirectory = Path.Combine(Environment.CurrentDirectory, @"TESTGlycoData");
            ...
            new EverythingRunnerEngine(new List<(string, MetaMorpheusTask)> { ("Task", task) }, new List<string> { raw }, new List<DbForTask> { db }, outputDirectory).Run();
