...
namespace Test
{
    ...
    public static class LocalizationTest
    {
        ...
        public static void TestNonSpecific()
        {
            ...
            DigestionParams digestionParams = new DigestionParams(protease: p, MaxMissedCleavages: 8, MinPeptideLength: 1, MaxPeptideLength: 9, InitiatorMethionineBehavior: InitiatorMethionineBehavior.Retain);
