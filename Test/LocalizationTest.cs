...
namespace Test
{
    ...
    public static class LocalizationTest
    {
        ...
        public static void TestLocalization()
        {
            ...
            // Was single peak!!!
            Assert.AreEqual(0, newPsm.MatchedIonDictOnlyMatchesMasses[ProductType.BnoB1ions].Count(b => b > 0));
            Assert.AreEqual(1, newPsm.MatchedIonDictOnlyMatchesMasses[ProductType.Y].Count(b => b > 0));
