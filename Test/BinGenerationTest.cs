...
namespace Test
{
    ...
    public class BinGenerationTest
    {
        ...
        public static void TestBinGeneration()
        {
            ...
            var possMod1 = prot1.Digest(st.CommonParameters.Protease, (int)st.CommonParameters.MaxMissedCleavages, st.CommonParameters.MinPeptideLength, st.CommonParameters.MaxPeptideLength, st.CommonParameters.InitiatorMethionineBehavior, new List<ModificationWithMass>()).First();
            ...
            var possMod3 = prot3.Digest(st.CommonParameters.Protease, (int)st.CommonParameters.MaxMissedCleavages, st.CommonParameters.MinPeptideLength, st.CommonParameters.MaxPeptideLength, st.CommonParameters.InitiatorMethionineBehavior, new List<ModificationWithMass>()).First();
            ...
            var possMod4 = prot4.Digest(st.CommonParameters.Protease, (int)st.CommonParameters.MaxMissedCleavages, st.CommonParameters.MinPeptideLength, st.CommonParameters.MaxPeptideLength, st.CommonParameters.InitiatorMethionineBehavior, new List<ModificationWithMass>()).First();
