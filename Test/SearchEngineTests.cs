...
namespace Test
{
    ...
    public static class SearchEngineTests
    {
        ...
        public static void TestSemiSpecificEnzymeEngineSingleN()
        {
            ...
            var precursorIndexEngine = new PrecursorIndexingEngine(proteinList, variableModifications, fixedModifications, new List<ProductType> { ProductType.B }, 1, DecoyType.Reverse, digestParams, 1, new List<string>());
