...
namespace Test
{
    ...
    public static class SearchEngineTests
    {
        ...
        public static void TestNonSpecificEnzymeSearchEngineSingleN()
        {
            ...
            CommonParameters CommonParameters = new CommonParameters(PrecursorMassTolerance: new PpmTolerance(5), DigestionParams: dp, ScoreCutoff: 1);
        ...
        public static void TestNonSpecificEnzymeSearchEngineSingleC()
        {
            ...
            Dictionary<Protease, Dictionary<CompactPeptideBase, HashSet<PeptideWithSetModifications>>> proteaseSortedCompactPeptideToProteinPeptideMatching = new Dictionary<Protease, Dictionary<CompactPeptideBase, HashSet<PeptideWithSetModifications>>>();
            var results = new NonSpecificEnzymeSequencesToActualPeptides(proteaseSortedCompactPeptideToProteinPeptideMatching, new List<PeptideSpectralMatch>
        ...
        public static void TestSemiSpecificEnzymeEngineSingleN()
        {
            ...
            GlobalVariables.ProteaseDictionary.Add(protease.Name, protease);
            CommonParameters CommonParameters = new CommonParameters( DigestionParams: new DigestionParams(protease: protease.Name, MinPeptideLength: 5, MaxModsForPeptides: 2, SemiProteaseDigestion: true), ProductMassTolerance: new AbsoluteTolerance(0.01), YIons: false, ScoreCutoff: 2);
        ...
        public static void TestSemiSpecificEnzymeEngineSingleC()
        {
            ...
            var sequence = allPsmsArray[0].BaseSequence;
            // Single search mode
            Assert.AreEqual(1, allPsmsArray.Length);
        ...
        public static void TestClassicSemiProtease()
        {
            ...
            CommonParameters CommonParameters = new CommonParameters(DigestionParams: new DigestionParams(protease: protease.Name, MaxMissedCleavages: 5), ProductMassTolerance: productMassTolerance);
            HashSet<DigestionParams> digestParams = new HashSet<DigestionParams> { CommonParameters.DigestionParams };
