    ...
    internal class VariantSearchTests
    {
        ...
        public void VariantSpecificOutputFiles()
        {
            ...
            expectedFiles = new HashSet<string> {
                "AllPeptides.psmtsv", "AllPSMs.psmtsv", "AllPSMs_FormattedForPercolator.tab", "AllQuantifiedProteinGroups.tsv", "AllQuantifiedPeaks.tsv", "AllQuantifiedPeptides.tsv", "prose.txt", "results.txt", "TestVariantPep.mzID", "VariantPeptides.psmtsv", "VariantAnalysisResultSummary.txt", "VariantPSMs.psmtsv" };
