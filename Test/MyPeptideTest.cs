...
namespace Test
{
    ...
    public class MyPeptideTest
    {
        ...
        public static void TestGoodPeptide()
        {
            ...
            var ye = prot.Digest(protease, 0, null, null, InitiatorMethionineBehavior.Retain, new List<ModificationWithMass>(), TerminusType.None).ToList();
        ...
        public static void TestIdenticalPeaks()
        {
            ...
            var ye = prot.Digest(GlobalTaskLevelSettings.ProteaseDictionary["trypsin"], 0, null, null, InitiatorMethionineBehavior.Retain, new List<ModificationWithMass>(), TerminusType.None).First();
        ...
        public static void TestNoCleavage()
        {
            ...
            var ye = prot.Digest(protease, int.MaxValue, null, null, InitiatorMethionineBehavior.Variable, fixedModifications, TerminusType.None).ToList();
        ...
        public static void TestPeptideWithSetModifications()
        {
            ...
            var protease = new Protease("Custom Protease", new List<string> { "K" }, new List<string>(), TerminusType.C, CleavageSpecificity.Full, null, null, null);
            var ye = prot.Digest(protease, 0, null, null, InitiatorMethionineBehavior.Retain, new List<ModificationWithMass>(), TerminusType.None).First();
            List<ModificationWithMass> variableModifications = new List<ModificationWithMass>();
            ModificationMotif.TryGetMotif("M", out ModificationMotif motif);
        ...
        public static void TestPeptideWithFixedModifications()
        {
            ...
            var ye = prot.Digest(protease, 0, null, null, InitiatorMethionineBehavior.Retain, fixedMods, TerminusType.None).First();
        ...
        public static void TestDigestIndices()
        {
            ...
            var protease = new Protease("Custom Protease", new List<string> { "K" }, new List<string>(), TerminusType.C, CleavageSpecificity.Full, null, null, null);
            var ye1 = prot.Digest(protease, 0, null, null, InitiatorMethionineBehavior.Retain, new List<ModificationWithMass>(), TerminusType.None).First();
            var ye2 = prot.Digest(protease, 0, null, null, InitiatorMethionineBehavior.Retain, new List<ModificationWithMass>(), TerminusType.None).Last();
        ...
        public static void TestDigestDecoy()
        {
            ...
            ye1 = prot.Digest(protease, 0, null, null, InitiatorMethionineBehavior.Retain, new List<ModificationWithMass>(), TerminusType.None).First();
            ye2 = prot.Digest(protease, 0, null, null, InitiatorMethionineBehavior.Retain, new List<ModificationWithMass>(), TerminusType.None).Last();
        ...
        public static void TestGoodPeptideWithLength()
        {
            ...
            var ye = prot.Digest(protease, 0, null, null, InitiatorMethionineBehavior.Retain, new List<ModificationWithMass>(), TerminusType.None).ToList();
            var ye1 = prot.Digest(protease, 0, 5, null, InitiatorMethionineBehavior.Retain, new List<ModificationWithMass>(), TerminusType.None).ToList();
            var ye2 = prot.Digest(protease, 0, null, 5, InitiatorMethionineBehavior.Retain, new List<ModificationWithMass>(), TerminusType.None).ToList();
            var ye3 = prot.Digest(protease, 0, 5, 8, InitiatorMethionineBehavior.Retain, new List<ModificationWithMass>(), TerminusType.None).ToList();
            Assert.AreEqual(3, ye.Count);
