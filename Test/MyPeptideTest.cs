...
namespace Test
{
    ...
    public class MyPeptideTest
    {
        ...
        public static void TestIdenticalPeaks()
        {
            ...
            var prot = new Protein("MMMM", null, null, mods, new int?[0], new int?[0], new string[0], null, null, false, false, null);
            ...
            var score = PsmParent.MatchIons(scan, new Tolerance(ToleranceUnit.PPM, 5), massArray, matchedIonMassesListPositiveIsMatch);
