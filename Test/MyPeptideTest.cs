...
namespace Test
{
    ...
    public static class MyPeptideTest
    {
        ...
        public static void TestIdenticalPeaks()
        {
            ...
            ClassicSearchEngine cse = new ClassicSearchEngine(globalPsms, arrayOfSortedMS2Scans, new List<Modification>(), new List<Modification>(), null, null, null, new List<Protein> { prot }, new OpenSearchMode(), CommonParameters, new List<string>());
        ...
        public static void TestVeryCloseExperimentalsModern()
        {
            ...
            var indexEngine = new IndexingEngine(new List<Protein> { prot }, new List<Modification>(), new List<Modification>(), null, null, null, 1, DecoyType.Reverse, CommonParameters, 30000, false, new List<FileInfo>(), new List<string>());
