...
namespace Test
{
    ...
    public static class MyPeptideTest
    {
        ...
        public static void TestGoodPeptide()
        {
            ...
            DigestionParams digestionParams = new DigestionParams(protease.Name, MaxMissedCleavages: 0, MinPeptideLength: 1, InitiatorMethionineBehavior: InitiatorMethionineBehavior.Retain);
        ...
        public static void TestLastPeaks()
        {
            ...
            {
                ProductMassTolerance = new PpmTolerance(5),
                DigestionParams = new DigestionParams(MaxMissedCleavages: 0, MinPeptideLength: 1,MaxModificationIsoforms: int.MaxValue, InitiatorMethionineBehavior: InitiatorMethionineBehavior.Retain),
                ConserveMemory = false,
                ScoreCutoff = 1
            };
            ClassicSearchEngine cse = new ClassicSearchEngine(globalPsms, arrayOfSortedMS2Scans, new List<ModificationWithMass>(), new List<ModificationWithMass>(), new List<Protein> { prot }, new List<ProductType> { ProductType.B, ProductType.Y }, new OpenSearchMode(), false, CommonParameters, new List<string>());
        ...
        public static void TestBadPeptide()
        {
            ...
            GlobalVariables.ProteaseDictionary.Add(protease.Name, protease);
            DigestionParams digestionParams = new DigestionParams(protease.Name, 0, 1, int.MaxValue, 1024, InitiatorMethionineBehavior.Retain);
        ...
        public static void TestPeptideWithSetModifications()
        {
            ...
            DigestionParams digestionParams = new DigestionParams("Custom Protease7", 0, 1, int.MaxValue, 1024, InitiatorMethionineBehavior.Variable, 3);
            List<ModificationWithMass> variableModifications = new List<ModificationWithMass>();
            ModificationMotif.TryGetMotif("M", out ModificationMotif motif);
