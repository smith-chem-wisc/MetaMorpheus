...
namespace Test
{
    ...
    internal static class AmbiguityTest
    {
        ...
        public static void TestResolveAmbiguities()
        {
            ...
            new ClassicSearchEngine(allPsmsArray_withAmbiguity, listOfSortedms2Scans, variableModifications, fixedModifications, null, null, proteinList, searchModes, CommonParameters_t, new List<string>()).Run(); //report all ambiguity TRUE
            new ClassicSearchEngine(allPsmsArray_withOutAmbiguity, listOfSortedms2Scans, variableModifications, fixedModifications, null, null, proteinList, searchModes, CommonParameters_f, new List<string>()).Run(); //report all ambiguity FALSE
