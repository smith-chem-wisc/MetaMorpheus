...
namespace MetaMorpheusCommandLine
{
    internal class Program
    {
        ...
        private static void RunModernSearchEngine()
        {
            ...
            List<SearchMode> searchModes = new List<SearchMode>() { new SinglePpmAroundZeroSearchMode("", 5) };

            ModernSearchEngine s = new ModernSearchEngine(myMsDataFile, spectraFileIndex, peptideIndex, keys, fragmentIndex, fragmentToleranceInDaltons, searchModes);
            s.Run();
        }
        ...
        private static void RunSearchTask()
        {
            ...
            SearchTask s = new SearchTask(modList, ism);
        ...
        private static void MyTaskEngine_startingSingleTaskHander(object sender, SingleTaskEventArgs e)
        {
            ...
            Console.WriteLine(e.theTask.ToString());
        }
