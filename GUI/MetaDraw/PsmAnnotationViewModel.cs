...
namespace ViewModels
{
    public class PsmAnnotationViewModel : INotifyPropertyChanged
    {
        ...
        public void DrawPeptideSpectralMatch(MsDataScan msDataScan, List<MatchedFragmentIon> MatchedIons, List<MatchedFragmentIon> BetaMatchedIons)
        {
        ...
        private PlotModel Draw(MsDataScan msDataScan, PsmFromTsv psmToDraw)
        {
            ...
            if (psmToDraw != null)
            {
                foreach (var peak in psmToDraw.MatchedIons.First().Value)
                {
                    OxyColor ionColor;
                ...
                {
                    foreach (var peak in psmToDraw.BetaPeptideMatchedIons.First().Value)
                    {
                        OxyColor ionColor;
        ...
        private PlotModel DrawMatchedFragmentIons(MsDataScan msDataScan, List<MatchedFragmentIon> MatchedIons, List<MatchedFragmentIon> BetaMatchedIons)
        {
            // x is m/z, y is intensity
            var spectrumMzs = msDataScan.MassSpectrum.XArray;
            var spectrumIntensities = msDataScan.MassSpectrum.YArray;
