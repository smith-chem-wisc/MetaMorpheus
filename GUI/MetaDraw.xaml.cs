...
namespace MetaMorpheusGUI
{
    ...
    public partial class MetaDraw : Window
    {
        ...
        public MetaDraw()
        {
            ...
            ////background worker initial
            //psmBack.DoWork += new DoWorkEventHandler(LoadPsms);
            //psmBack.ProgressChanged += new ProgressChangedEventHandler(bw_ProgressChanged);
            //psmBack.WorkerReportsProgress = true;
        }
