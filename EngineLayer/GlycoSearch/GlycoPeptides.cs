...
namespace EngineLayer.GlycoSearch
{
    public static class GlycoPeptides
    {
        ...
        /// </summary>
        /// <returns></returns>
        public static double Calc_pGlycoScore_SinglePep(List<MatchedFragmentIon> matchedFragmentIons, List<Product> theoreticalProducts, CommonParameters commonParameters, double g = 0.70, double w = 0.35)
        {
            double score = 0;
            double score_p = 0;
        ...
        /// </summary>
        public static double Calc_pGlycoScore(List<MatchedFragmentIon> matchedFragmentIons, List<Product> theoreticalProducts, CommonParameters commonParameters, double a = 0.56, double b = 1.42, double g = 0.70, double w = 0.35)
        {
            //The function is using pGlyco score equation.
            double score = 0;
            double score_g = 0;
