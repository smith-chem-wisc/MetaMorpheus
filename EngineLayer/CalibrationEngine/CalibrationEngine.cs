...
namespace EngineLayer.Calibration
{
    public class CalibrationEngine : MetaMorpheusEngine
    {
        ...
        private readonly List<SingleScanMatches> goodIdentifications;
        ...
        private DataPointAquisitionResults GetDataPoints()
        {
            ...
            {
                SingleScanMatches identification = goodIdentifications[matchIndex];
                ...
                var representativeSinglePeptide = identification.MostProbable.PeptidesWithSetModifications.First();
        ...
        private IEnumerable<LabeledMs1DataPoint> SearchMS1Spectra(double[] originalMasses, double[] originalIntensities, int ms2spectrumIndex, int direction, HashSet<Tuple<double, double>> peaksAddedHashSet, int peptideCharge, SingleScanMatches identification)
        {
            int theIndex;
            if (direction == 1)
        ...
        private IEnumerable<LabeledMs2DataPoint> SearchMS2Spectrum(IMsDataScanWithPrecursor<IMzSpectrum<IMzPeak>> ms2DataScan, Proteomics.Peptide peptide, int peptideCharge, SingleScanMatches identification)
        {
            numFragmentsIdentified = 0;
