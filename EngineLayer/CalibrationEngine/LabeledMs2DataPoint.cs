namespace EngineLayer.Calibration
{
    public class LabeledMs2DataPoint : IHasInputsAndOutputs
    {
        ...
        public LabeledMs2DataPoint(double mz, double rt, double totalIonCurrent, double? injectionTime, double label, Psm identification)
        {
            this.mz = mz;
            this.rt = rt;
        ...
        public static string TabSeparatedHeaderForMs1 { get { return "mz\trt\tTIC\tInjectionTime\tLabel"; } }
