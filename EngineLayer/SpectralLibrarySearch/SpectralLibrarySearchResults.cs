...
namespace EngineLayer.spectralLibrarySearch
{
    public class SpectralLibrarySearchResults
    {
        ...
        public SpectralLibrarySearchResults(LibrarySpectrum theExperimentalSpectrum, int indexOfExperimentalSpectrum, List<SpectralLibrarayMatch> spectralLibrarayMatchs)
        {
        ...
        public LibrarySpectrum TheExperimentalSpectrum { get; set; }
