...
namespace EngineLayer.spectralLibrarySearch
{
    public class SpectralLibrarayMatch
    {
        ...
        public LibrarySpectrum MatchedSpectrumFromLibrary { get; set; }
        ...
        private List<(int Notch, LibrarySpectrum spectrum)> _BestLibraryMatchingPeptides;
        private double ScoreCutoff = 0.5;
        public double RunnerUpScore { get; set; }
        public Dictionary<LibrarySpectrum, List<MatchedFragmentIon>> SpectrumToMatchingFragments { get; private set; }
        public double Xcorr;

        public SpectralLibrarayMatch(LibrarySpectrum matchedSpectrumFromLibrary, int notch, double matchScore,int scanIndex, Ms2ScanWithSpecificMass scan, CommonParameters commonParameters, List<MatchedFragmentIon> matchedPeaks,double xcorr)
        {
        ...
        public void AddOrReplace(LibrarySpectrum matchedSpectrum, double newScore, int notch, bool reportAllAmbiguity, List<MatchedFragmentIon> matchedFragmentIons, double newXcorr)
        {
