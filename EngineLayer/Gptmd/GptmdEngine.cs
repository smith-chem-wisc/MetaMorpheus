...
namespace EngineLayer.Gptmd
{
    public class GptmdEngine : MetaMorpheusEngine
    {
        ...
        private readonly List<SingleScanMatches> allIdentifications;
        ...
        public GptmdEngine(List<SingleScanMatches> allIdentifications, List<ModificationWithMass> gptmdModifications, IEnumerable<Tuple<double, double>> combos, Tolerance precursorMassTolerance, List<string> nestedIds) : base(nestedIds)
        {
        ...
        protected override MetaMorpheusEngineResults RunSpecific()
        {
            ...
            foreach (var ye in allIdentifications.Where(b => b.FdrInfo.QValueNotch <= 0.01 && !b.MostProbable.IsDecoy))
            {
                var baseSequence = ye.MostProbable.BaseSequence;
                foreach (var peptide in ye.MostProbable.PeptidesWithSetModifications)
