...
namespace EngineLayer
{
    public class LocalizationEngine : MetaMorpheusEngine
    {
        ...
        private readonly IEnumerable<SingleScanMatches> allResultingIdentifications;
        ...
        public LocalizationEngine(IEnumerable<SingleScanMatches> allResultingIdentifications, List<ProductType> lp, IMsDataFile<IMsDataScan<IMzSpectrum<IMzPeak>>> myMsDataFile, Tolerance fragmentTolerance, List<string> nestedIds) : base(nestedIds)
        {
        ...
        protected override MetaMorpheusEngineResults RunSpecific()
        {
            foreach (var ok in allResultingIdentifications)
            {
                ...
                var representative = ok.MostProbable.PeptidesWithSetModifications.First();
                ...
                foreach (var huh in lp)
                {
                    ...
                    SingleScanMatches.MatchIons(theScan, fragmentTolerance, ionMasses, matchedIonMassesListPositiveIsMatch);
                ...
                for (int indexToLocalize = 0; indexToLocalize < representative.Length; indexToLocalize++)
                {
                    ...
                    var score = SingleScanMatches.MatchIons(theScan, fragmentTolerance, gg, matchedIonMassesListPositiveIsMatch);
