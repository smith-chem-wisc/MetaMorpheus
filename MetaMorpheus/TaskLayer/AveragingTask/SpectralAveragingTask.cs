    ...
    public class SpectralAveragingTask : MetaMorpheusTask
    {
            ...
            FileSpecificParameters[] fileSettingsList)
        {
            ...
            for (int spectraFileIndex = 0; spectraFileIndex < currentRawFileList.Count; spectraFileIndex++)
            {
                ...
                if (originalFileExtension.Equals(".mgf", StringComparison.OrdinalIgnoreCase) || originalFileExtension.Equals(".d", StringComparison.OrdinalIgnoreCase) || originalUnaveragedFilepath.Equals(".msalign", StringComparison.OrdinalIgnoreCase))
                {
