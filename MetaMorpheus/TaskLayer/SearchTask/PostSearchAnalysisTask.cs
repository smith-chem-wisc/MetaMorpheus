    ...
    public class PostSearchAnalysisTask : MetaMorpheusTask
    {
        ...
        private void WriteIndividualPeptideResults()
        {
            ...
            foreach (var psmFileGroup in peptidesGroupedByFile)
            {
                ...
                // write summary text
                string peptideResultsText = strippedFileName + " - All target peptides with " + peptidesToWrite.GetFilterTypeString() + " = " + Math.Round(peptidesToWrite.FilterThreshold, 2) + ": " + peptidesToWrite.TargetPsmsAboveThreshold;
        ...
        private void UpdateSpectralLibrary()
        {
            ...
            foreach (var ogLibrarySpectrum in originalLibrarySpectra)
            {
                ...
                {
                    // if the spectrum is included in the original library and absent from our search, it's added to the updated library
                    updatedLibrarySpectra.Add(ogLibrarySpectrum);
                }
            }
