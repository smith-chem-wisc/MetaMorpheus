...
namespace TaskLayer
{
    public class PostSearchAnalysisTask : MetaMorpheusTask
    {
        ...
        private void WritePsmResults()
        {
            ...
            string psmResultsText = "All target PSMs with " + nameof(psmsForPsmResults.FilterType) + " = " + Math.Round(psmsForPsmResults.FilterThreshold, 2) + ": " +
        ...
        private void WritePeptideResults()
        {
            ...
            string peptideResultsText = "All target peptides with " + nameof(peptidesForPeptideResults.FilterType) + " = " + Math.Round(peptidesForPeptideResults.FilterThreshold, 2) + ": " +
        ...
        private void WriteIndividualPsmResults()
        {
            ...
            foreach (var psmFileGroup in psmsGroupedByFile)
            {
                ...
                // write summary text
                string psmResultsText = strippedFileName + " - All target PSMs with " + nameof(psmsToWrite.FilterType) + " = " + Math.Round(psmsToWrite.FilterThreshold, 2) + ": " +
        ...
        private void WriteIndividualPeptideResults()
        {
            ...
            foreach (var psmFileGroup in peptidesGroupedByFile)
            {
                ...
                var peptidesToWrite = Filter(peptideFileGroup,
                    includeDecoys: Parameters.SearchParameters.WriteDecoys,
                    includeContaminants: Parameters.SearchParameters.WriteContaminants,
                    includeAmbiguous: true,
                    includeHighQValuePsms: Parameters.SearchParameters.WriteHighQValuePsms,
                ...
                // write summary text
                string peptideResultsText = strippedFileName + " - All target peptides with " + nameof(peptidesToWrite.FilterType) + " = " + Math.Round(peptidesToWrite.FilterThreshold, 2) + ": " +
