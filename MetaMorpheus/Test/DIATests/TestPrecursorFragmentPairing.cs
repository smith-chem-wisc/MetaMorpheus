...
namespace Test
{
    public class TestPrecursorFragmentPairing
    {
        ...
        public static void TestCorrelationCalculation()
        {
            ...
            double corr = PrecursorFragmentGroup.CalculateXicCorrelationXYData(xic1, xic2);
            ...
            corr = PrecursorFragmentGroup.CalculateXicCorrelationXYData(xic1, xic3);
            Assert.That(corr, Is.EqualTo(-1.0).Within(1e-6));
            ...
            corr = PrecursorFragmentGroup.CalculateXicCorrelationXYData(xic1, xic4);
            ...
            corr = PrecursorFragmentGroup.CalculateXicCorrelationXYData(xic1, xic2);
            Assert.That(corr, Is.EqualTo(1.0).Within(1e-6));
        }
    }
}
