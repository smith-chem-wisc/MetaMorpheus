...
namespace Test
{
    ...
    public static class AveragingTests
    {
        ...
        public static void TestExperimentalDesignFunctionsProperly()
        {
            ...
            Assert.That(File.Exists(Path.Combine(testPath, "Task1-Average", "miniA549-averaged.mzML")));
            Assert.That(File.Exists(Path.Combine(testPath, "Task1-Average", "miniA549-averaged.toml")));
            ...
            Assert.That(File.Exists(Path.Combine(testPath, "Task2-Search", "miniA549-averaged.mzID")));
        ...
        public static void TestAveragingWithOtherTasks()
        {
            ...
            Assert.That(File.Exists(Path.Combine(testPath, "Task1-Calib", "miniA549-calib.mzML")));
            Assert.That(File.Exists(Path.Combine(testPath, "Task1-Calib", "miniA549-calib.toml")));
            ...
            Assert.That(File.Exists(Path.Combine(testPath, "Task2-Average", "miniA549-calib-averaged.mzML")));
            Assert.That(File.Exists(Path.Combine(testPath, "Task2-Average", "miniA549-calib-averaged.toml")));
            ...
            Assert.That(File.Exists(Path.Combine(testPath, "Task3-Search", "miniA549-calib-averaged.mzID")));

            // ensure averaged properly
            var calibratedFiles = Mzml.LoadAllStaticData(Path.Combine(testPath, "Task1-Calib", "miniA549-calib.mzML"));
            var averagedFiles = Mzml.LoadAllStaticData(Path.Combine(testPath, "Task2-Average", "miniA549-calib-averaged.mzML"));
