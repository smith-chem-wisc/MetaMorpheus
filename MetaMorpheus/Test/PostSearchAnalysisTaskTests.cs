...
namespace Test
{
    ...
    public static class PostSearchAnalysisTaskTests
    {
        ...
        public static void AllResultsAndResultsTxtTests()
        {
            ...
            // produced by searching the file by itself. They should be identical
            int b6_2ExpectedPsms = 6;
            int b6_2ExpectedPeptides = 5;
            int b6_2ExpectedProteinGroups = 4;
            ...
            //Assert.AreEqual("Target protein groups within 1 % FDR in sliced_b6_2: " + b6_2ExpectedProteinGroups, allResults[25]);
            ...
            //Assert.AreEqual("Target protein groups within 1 % FDR in sliced_b6_2: " + b6_2ExpectedProteinGroups, results[20]);
            ...
            Assert.AreEqual("All target protein groups with q-value = 0.01 (1% FDR): " + b6_2ExpectedProteinGroups, singleFileResults[9]); 
