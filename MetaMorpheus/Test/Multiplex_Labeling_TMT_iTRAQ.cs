    ...
    internal static class Multiplex_Labeling_TMT_iTRAQ
    {
        ...
        public static void TestMultiplexIonIntensityDetection()
        {
            ...
            MzSpectrum fakeSpectrum = new MzSpectrum(
                ...
                shouldCopy: false);
            Assert.That(fakeSpectrum.YArray, Is.EqualTo(PostSearchAnalysisTask.GetMultiplexIonIntensities(fakeSpectrum, ionMzs, tol)));
            ...
            fakeSpectrum = new MzSpectrum(
                ...
                intensities: new double[] { 2, 4, 6, 8, 10 },
                shouldCopy: false);
            Assert.That(new double[] { 2, 0, 6, 0, 10 }, Is.EqualTo(PostSearchAnalysisTask.GetMultiplexIonIntensities(fakeSpectrum, ionMzs, tol)));
            ...
            fakeSpectrum = new MzSpectrum(
                ...
                shouldCopy: false);
            Assert.That(new double[] { 2, 4, 6, 0, 0 }, Is.EqualTo(PostSearchAnalysisTask.GetMultiplexIonIntensities(fakeSpectrum, ionMzs, tol)));
            ...
            fakeSpectrum = new MzSpectrum(
                ...
                shouldCopy: false);
            Assert.That(new double[] { 1, 2, 3, 4, 5, 6 }, Is.EqualTo(PostSearchAnalysisTask.GetMultiplexIonIntensities(fakeSpectrum, ionMzs, tol)));
        }
        ...
        public static void TestDoNotCountDiagnosticIonsInScore_HCD()
        {
            ...
            Assert.That(psm.MatchedIons.Where(i => i.NeutralTheoreticalProduct.ProductType != ProductType.D).Count(), Is.EqualTo((int)psm.Score)); //integer part of the MM score should match the count of non-diagnostic ions
