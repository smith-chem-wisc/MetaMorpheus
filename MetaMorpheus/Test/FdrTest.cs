...
namespace Test
{
    ...
    public static class FdrTest
    {
        ...
        public static void TestComputePEPValue()
        {
            ...
            PeptideWithSetModifications varPep = variantProtein.GetVariantBioPolymers()
                .SelectMany(p => p.Digest(CommonParameters.DigestionParams, null, null)).FirstOrDefault();
