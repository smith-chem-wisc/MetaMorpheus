...
namespace Test
{
    ...
    public class TestOGlyco
    {
        ...
        [Test]
        public static void OGlycoSearch_WithNGlycanAsVariableMod_DoesNotCrash()
        {
            ...
            //
            // any N-glycan mass matched in this data must come from the "N1" variable mod, forcing candidate
