...
namespace Test
{
    ...
    public static class RobTest
    {
        ...
        public static void TestParsimony()
        {
            ...
            List<string> parsimonyProteinSequences = psms.SelectMany(p => p.BestMatchingBioPolymersWithSetMods.Select(v => v.WithSetMods.Parent)).Select(v => v.BaseSequence).Distinct().ToList();
