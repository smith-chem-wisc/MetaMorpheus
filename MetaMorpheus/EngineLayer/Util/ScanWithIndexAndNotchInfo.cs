...
{
    internal class ScanWithIndexAndNotchInfo(double notch, int scanIndex)
    {
    ...
    internal class ExtendedScanWithIndexAndNotchInfo(Ms2ScanWithSpecificMass scan, double notch, int scanIndex) : ScanWithIndexAndNotchInfo(notch, scanIndex)
    {
