...
namespace EngineLayer.Indexing
{
    ...
    {
        public IndexingResults(List<PeptideWithSetModifications> peptideIndex, FragmentIndex fragmentIndex, List<int>[] precursorIndex, IndexingEngine indexParams) : base(indexParams)
        {
