    ...
    internal class MyAnalysisClass
    {
        ...
        internal static void IdentifyUnimodBins(MyNewTreeStructure myTreeStructure, double v)
        {
            foreach (var bin in myTreeStructure.finalBins)
            {
                ...
                foreach (var hm in Program.unimodDeserialized.modifications)
                {
        ...
        internal static void IdentifyUniprotBins(MyNewTreeStructure myTreeStructure, double v)
        {
            ...
            {
                HashSet<string> ok = new HashSet<string>();
                foreach (var hm in Program.uniprotDeseralized)
                {
        ...
        internal static void IdentifyMine(MyNewTreeStructure myTreeStructure, double v)
        {
            ...
            myInfos.Add(new MyInfo(-91.009185, "-Carbamidomethylation - H2S: Usually on cysteine."));
