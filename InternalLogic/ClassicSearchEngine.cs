...
namespace InternalLogicEngineLayer
{
	public class ClassicSearchEngine : MyEngine
	{
		...
		IEnumerable<LocalMs2Scan> GetAcceptableScans(LocalMs2Scan[] listOfSortedms2Scans, double peptideMonoisotopicMass, SearchMode searchMode)
		{
		...
		int GetFirstScanWithMassOverOrEqual(LocalMs2Scan[] listOfSortedms2Scans, double minimum)
		{
