...
namespace InternalLogic
{
    public class SoftwareLockMassParams
    {
        ...
        public AllTasksParams po;

        #region Constructors

        public SoftwareLockMassParams(IMsDataFile<IMzSpectrum<MzPeak>> myMsDataFile, int randomSeed, double toleranceInMZforMS2Search, AllTasksParams po)
        {
